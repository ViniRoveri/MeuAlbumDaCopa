...
const selecoes = {
    ...
    QAT: [3,4,8,11,12,16,19],
    ECU: [1,5,6,7,8,11,12,14,15,19,20],
    SEN: [1,5,6,7,8,10,17,20],
    NED: [10,13,15,18],
    ENG: [1,3,4,9,13,16,17,19,20],
    IRN: [3,15,19,20],
    USA: [1,3,4,6,14,15,19,20],
    WAL: [3,5,6,7,14,17,19,20],
    ARG: [1,4,5,8,9,17,18],
    KSA: [3,7,10,13,15,16,19],
    MEX: [4,6,7,11,14,15,20],
    POL: [1,3,8,9,10,16,17],
    FRA: [5,6,7,8,9,11,13,14,15,16,18],
    AUS: [1,3,6,9,10,12,15,17,19],
    DEN: [4,5,10,11,12,13,17,19,20],
    TUN: [1,4,7,8,9,10,11,14,16],
    ESP: [3,4,5,9,10,14,16,18,19],
    CRC: [4,7,8,10,11,12,13,15,16,20],
    GER: [5,7,9,10,13,16,17,19],
    JPN: [4,6,7,9,13,15,17,19],
    BEL: [1,3,4,5,6,7,10,11,12,14,15,16,18],
    CAN: [1,3,6,8,14,15,17,19],
    MAR: [8,13,14,17,18,19,20],
    CRO: [3,5,11,12,13,14,16,17,20],
    BRA: [5,16,18,19],
    SRB: [1,4,5,7,9,11,12,13,17],
    SUI: [10,12,14,18,19],
    CMR: [4,5,9,10,13,14,19,20],
